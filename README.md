...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/red-tooth-5c68)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/red-tooth-5c68
```

A live public deployment of this template is available at [https://red-tooth-5c68.templates.workers.dev](https://red-tooth-5c68.templates.workers.dev)
